...
<div class="wrapper">
  ...
  <main class="page-content">
    <div class="page-breadcrumb d-none d-sm-flex align-items-center gap-2 mb-3">
      <div class="breadcrumb-title pe-3">International Office Reports</div>
      <div class="ps-2">
    ...
    <div class="card border-0 shadow-sm mb-3">
      ...
      <div class="card-body">
        <form method="GET" action="{{ route('iqac.international-office.reports') }}" class="row g-2 align-items-end">
          <div class="col-md-3">
          ...
          <div class="col-md-3 d-flex gap-2">
            ...
            <a href="{{ route('iqac.international-office.reports') }}" class="btn btn-light">Reset</a>
          </div>
        </form>
      </div>
    </div>
    ...
    <div class="card border-0 shadow-sm mb-3">
      <div class="card-header bg-white">
        <h6 class="mb-0">International Office Events Snapshot</h6>
      </div>
        ...
        <div class="table-responsive">
          <table class="table table-hover mb-0 align-middle">
            ...
            <tbody>
              ...
              @empty
              <tr>
                <td colspan="5" class="text-center py-4 text-muted">No international office events found.</td>
              </tr>
              @endforelse
            </tbody>
          </table>
          ...
          <table class="table table-hover mb-0 align-middle">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="fw-semibold">{{ optional(optional($report->event)->activityType)->title ?? '-' }}</div>
                  <div class="small text-muted">{{ optional($report->event)->visiting_institution_name ?? '-' }}</div>
                  <div class="small text-muted">{{ optional(optional($report->event)->trip_start_date)->format('d M Y') }} - {{ optional(optional($report->event)->trip_end_date)->format('d M Y') }}</div>
                </td>
                <td>
                ...
                <td style="min-width: 320px;">
                  <form method="POST" action="{{ route('iqac.international-office.reports.status', $report->id) }}" class="row g-2">
                    @csrf
                    <div class="col-5">
