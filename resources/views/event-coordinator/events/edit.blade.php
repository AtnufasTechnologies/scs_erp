        ...
        <div class="col-lg-8">
          <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom py-3">
              <h5 class="mb-0 fw-bold"><i class="fas fa-edit text-secondary me-2"></i>Edit Event</h5>
            </div>
            <div class="card-body">
              <form action="{{ route('event-coordinator.events.update', $event) }}" method="POST" enctype="multipart/form-data">
                @csrf @method('PUT')
                ...
                <div class="d-flex gap-2 mt-4">
                  ...
                  <a href="{{ route('event-coordinator.events.show', $event) }}" class="btn btn-outline-secondary">Cancel</a>
                </div>
              </form>
            </div>
          </div>
