              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      @if($scorer->status == 'approved')
                      <span class="badge bg-success">Approved</span>
                      @elseif($scorer->status == 'submitted')
                      <span class="badge bg-warning">Submitted</span>
                      @else
                      <span class="badge bg-secondary">{{ ucfirst($scorer->status) }}</span>
                      @endif
                    </td>
                    <td>
                      <a href="{{ route('hr.api-scores.show', $scorer->id) }}" class="btn btn-sm btn-info">
