  ...
  <main class="page-content">
    ...
    <div class="card">
      <div class="card-header bg-primary text-white">
        <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Create New Grade Level</h5>
      </div>
      <div class="card-body">
        <form action="{{ route('hr.grade-levels.store') }}" method="POST">
          @csrf
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"
                value="{{ old('code') }}" maxlength="50" placeholder="e.g., L14, L13, L12">
          ...
          <div class="row mb-3">
            <div class="col-md-4">
              ...
              <input type="number" name="min_salary" class="form-control @error('min_salary') is-invalid @enderror"
                value="{{ old('min_salary') }}" min="0" step="0.01" placeholder="0.00">
            ...
            <div class="col-md-4">
              ...
              <input type="number" name="max_salary" class="form-control @error('max_salary') is-invalid @enderror"
                value="{{ old('max_salary') }}" min="0" step="0.01" placeholder="0.00">
            ...
            <div class="col-md-4">
              ...
              <input type="number" name="level_order" class="form-control @error('level_order') is-invalid @enderror"
                value="{{ old('level_order', 0) }}" min="0" required>
          ...
          <div class="mt-4">
            <button type="submit" class="btn btn-primary">
              <i class="fas fa-save me-1"></i>Create Grade Level
            </button>
