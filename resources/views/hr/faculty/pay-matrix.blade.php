  ...
  <div class="ps-3">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0 p-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('hr.faculty.index') }}">Employee List</a></li>
        <li class="breadcrumb-item active" aria-current="page">Salary Master</li>
      </ol>
    </nav>
  </div>
  <div class="ms-auto">
    <a href="{{ route('hr.faculty.index') }}" class="btn btn-secondary btn-sm">
...
<div class="alert alert-info">
  <strong>{{ $faculty->full_name }}</strong> ({{ $faculty->USER_CODE }}) salary master customization. Deductions are managed by Accounts during payroll processing.
</div>

<div class="alert alert-warning">
  Changes on this page are saved as faculty-level earnings/allowance overrides. The assigned base pay matrix remains unchanged.
</div>

<form action="{{ route('hr.faculty.pay-matrix.update', $faculty->id) }}" method="POST">
  @csrf
  @method('PUT')
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <div class="row mb-3">
        <input type="hidden" name="matrix_name" value="{{ old('matrix_name', $payMatrix->matrix_name ?? trim($faculty->full_name . ' Custom Matrix')) }}">
        <div class="col-md-3">
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-4">
          ...
          <select name="employment_type" class="form-select @error('employment_type') is-invalid @enderror" required>
            ...
            <option value="visiting" {{ old('employment_type', $payMatrix->employment_type) == 'adjunct'     ? 'selected' : '' }}>Adjunct</option>
          </select>
      ...
      <div class="row mb-3">
        <div class="col-md-6">
          ...
          <input type="text" name="designation" class="form-control @error('designation') is-invalid @enderror"
            value="{{ old('designation', $payMatrix->designation) }}" maxlength="255" placeholder="Override with custom designation">
        ...
        <div class="col-md-6">
          ...
          <input type="text" name="grade_level" class="form-control @error('grade_level') is-invalid @enderror"
            value="{{ old('grade_level', $payMatrix->grade_level) }}" maxlength="255" placeholder="Override with custom grade level">
      ...
      <div class="row mb-3">
        <div class="col-md-3">
          ...
          <select name="status" class="form-select @error('status') is-invalid @enderror" required>
            <option value="active" {{ old('status', $payMatrix->status ?? 'active') == 'active'   ? 'selected' : '' }}>Active</option>
        ...
        <div class="col-md-3">
          ...
          <input type="number" name="default_working_days" class="form-control @error('default_working_days') is-invalid @enderror"
            value="{{ old('default_working_days', $payMatrix->default_working_days ?? 26) }}" min="1" max="31" required>
      ...
      <div class="row mb-3">
        <div class="col-md-3">
          ...
          <div class="input-group">
            ...
            <input type="number" name="basic_salary" class="form-control @error('basic_salary') is-invalid @enderror"
              value="{{ old('basic_salary', $payMatrix->basic_salary ?? 0) }}" min="0" step="0.01" required>
        ...
        <div class="col-md-3">
          ...
          <input type="number" name="da_percentage" class="form-control @error('da_percentage') is-invalid @enderror"
            value="{{ old('da_percentage', $payMatrix->da_percentage ?? 0) }}" min="0" max="100" step="0.01">
        ...
        <div class="col-md-3">
          ...
          <input type="number" name="da_fixed" class="form-control @error('da_fixed') is-invalid @enderror"
            value="{{ old('da_fixed', $payMatrix->da_fixed ?? 0) }}" min="0" step="0.01">
      ...
      <div class="row mb-3">
        <div class="col-md-3">
          ...
          <input type="number" name="hra_percentage" class="form-control @error('hra_percentage') is-invalid @enderror"
            value="{{ old('hra_percentage', $payMatrix->hra_percentage ?? 0) }}" min="0" max="100" step="0.01">
        ...
        <div class="col-md-3">
          ...
          <input type="number" name="hra_fixed" class="form-control @error('hra_fixed') is-invalid @enderror"
            value="{{ old('hra_fixed', $payMatrix->hra_fixed ?? 0) }}" min="0" step="0.01">
        ...
        <div class="col-md-3">
          ...
          <input type="number" name="ta" class="form-control @error('ta') is-invalid @enderror"
            value="{{ old('ta', $payMatrix->ta ?? 0) }}" min="0" step="0.01">
        ...
        <div class="col-md-3">
          ...
          <input type="number" name="medical_allowance" class="form-control @error('medical_allowance') is-invalid @enderror"
            value="{{ old('medical_allowance', $payMatrix->medical_allowance ?? 0) }}" min="0" step="0.01">
      ...
      <div class="row mb-3">
        <div class="col-md-3">
          ...
          <input type="number" name="special_allowance" class="form-control @error('special_allowance') is-invalid @enderror"
            value="{{ old('special_allowance', $payMatrix->special_allowance ?? 0) }}" min="0" step="0.01">
        ...
        <div class="col-md-3">
          ...
          <input type="number" name="research_allowance" class="form-control @error('research_allowance') is-invalid @enderror"
            value="{{ old('research_allowance', $payMatrix->research_allowance ?? 0) }}" min="0" step="0.01">
        ...
        <div class="col-md-3">
          ...
          <input type="number" name="other_allowances" class="form-control @error('other_allowances') is-invalid @enderror"
            value="{{ old('other_allowances', $payMatrix->other_allowances ?? 0) }}" min="0" step="0.01">
      ...
      <div class="row mb-3">
        <div class="col-md-4">
          ...
          <input type="number" name="annual_increment_percentage" class="form-control @error('annual_increment_percentage') is-invalid @enderror"
            value="{{ old('annual_increment_percentage', $payMatrix->annual_increment_percentage ?? 0) }}" min="0" max="100" step="0.01">
  ...
  <div class="mb-4">
    <button type="submit" class="btn btn-primary">
      <i class="fas fa-save me-1"></i>Update Salary Master
    </button>
    <a href="{{ route('hr.faculty.index') }}" class="btn btn-secondary ms-2">
