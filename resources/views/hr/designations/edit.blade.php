...
<div class="wrapper">
  ...
  <main class="page-content">
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
      ...
      <div class="ms-auto">
        <a href="{{ route('hr.designations.show', $designation) }}" class="btn btn-info btn-sm">
    ...
    <div class="card">
      <div class="card-header bg-warning text-dark">
        <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Designation</h5>
      </div>
      <div class="card-body">
        <form action="{{ route('hr.designations.update', $designation) }}" method="POST">
          @csrf
          @method('PUT')
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                value="{{ old('name', $designation->name) }}" maxlength="255" required autofocus>
              @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-6">
              <label class="form-label">Code</label>
              <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"
                value="{{ old('code', $designation->code) }}" maxlength="50" placeholder="e.g., PROF, ASSOC_PROF">
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <select name="category" class="form-select @error('category') is-invalid @enderror" required>
                ...
                <option value="teaching" {{ old('category', $designation->category) == 'teaching' ? 'selected' : '' }}>Teaching</option>
                <option value="non-teaching" {{ old('category', $designation->category) == 'non-teaching' ? 'selected' : '' }}>Non-Teaching</option>
                <option value="administrative" {{ old('category', $designation->category) == 'administrative' ? 'selected' : '' }}>Administrative</option>
            ...
            <div class="col-md-3">
              ...
              <input type="number" name="hierarchy_level" class="form-control @error('hierarchy_level') is-invalid @enderror"
                value="{{ old('hierarchy_level', $designation->hierarchy_level) }}" min="0" required>
          ...
          <div class="mt-4">
            ...
            <a href="{{ route('hr.designations.show', $designation) }}" class="btn btn-info ms-2">
              <i class="fas fa-eye me-1"></i>View
            </a>
