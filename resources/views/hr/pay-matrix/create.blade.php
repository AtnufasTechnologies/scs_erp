    ...
    <div class="card-body">
      <div class="row mb-3">
        <div class="col-md-3">
          ...
          <input type="number" name="pf_percentage" class="form-control @error('pf_percentage') is-invalid @enderror"
            value="{{ old('pf_percentage', 0) }}" min="0" max="100" step="0.01">
          @error('pf_percentage')<div class="invalid-feedback">{{ $message }}</div>@enderror
        </div>
        <div class="col-md-3">
          <label class="form-label">PF Fixed (₹)</label>
          <input type="number" name="pf_fixed" class="form-control @error('pf_fixed') is-invalid @enderror"
            value="{{ old('pf_fixed', 0) }}" min="0" step="0.01">
          @error('pf_fixed')<div class="invalid-feedback">{{ $message }}</div>@enderror
        </div>
        <div class="col-md-3">
          <label class="form-label">ESI (%)</label>
          <input type="number" name="esi_percentage" class="form-control @error('esi_percentage') is-invalid @enderror"
            value="{{ old('esi_percentage', 0) }}" min="0" max="100" step="0.01">
          @error('esi_percentage')<div class="invalid-feedback">{{ $message }}</div>@enderror
        </div>
        <div class="col-md-3">
          <label class="form-label">ESI Fixed (₹)</label>
          <input type="number" name="esi_fixed" class="form-control @error('esi_fixed') is-invalid @enderror"
            value="{{ old('esi_fixed', 0) }}" min="0" step="0.01">
          @error('esi_fixed')<div class="invalid-feedback">{{ $message }}</div>@enderror
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-md-3">
          <label class="form-label">Professional Tax (₹)</label>
          <input type="number" name="professional_tax" class="form-control @error('professional_tax') is-invalid @enderror"
            value="{{ old('professional_tax', 0) }}" min="0" step="0.01">
          @error('professional_tax')<div class="invalid-feedback">{{ $message }}</div>@enderror
        </div>
        <div class="col-md-3">
          <label class="form-label">TDS (%)</label>
          <input type="number" name="tds_percentage" class="form-control @error('tds_percentage') is-invalid @enderror"
            value="{{ old('tds_percentage', 0) }}" min="0" max="100" step="0.01">
          @error('tds_percentage')<div class="invalid-feedback">{{ $message }}</div>@enderror
        </div>
        <div class="col-md-3">
          <label class="form-label">Other Deductions (₹)</label>
          <input type="number" name="other_deductions" class="form-control @error('other_deductions') is-invalid @enderror"
            value="{{ old('other_deductions', 0) }}" min="0" step="0.01">
