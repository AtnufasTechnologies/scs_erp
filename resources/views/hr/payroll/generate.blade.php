            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-sm btn-primary" onclick="assignMatrix({{ $faculty->id }})">
                  <i class="fas fa-clipboard"></i> Assign
                </button>
              </td>
            </tr>
            @endforeach
        ...
        <div class="col-md-5">
          ...
          <div>
            <button type="submit" class="btn btn-primary">
              <i class="fas fa-play"></i> Generate Salary Slips
            </button>
            <button type="button" class="btn btn-secondary" onclick="toggleFacultySelection()">
              <i class="fas fa-tasks"></i> Select Specific Faculty
            </button>
          </div>
        </div>
      </div>
...
<script>
  function assignMatrix(facultyId) {
    ...
    form.method = 'POST';
    form.action = "{{ route('hr.payroll.assign-pay-matrix') }}";
