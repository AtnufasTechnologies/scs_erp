...
<div class="wrapper">
  ...
  <main class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center gap-2">
      <div class="breadcrumb-title pe-3">Edit Leave Application</div>
      <div class="ps-2">
      ...
      <div class="col-lg-8 mx-auto">
        <div class="card shadow-sm border-0">
          <div class="card-header bg-warning text-dark py-3">
            <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Leave Application</h5>
          </div>
          <div class="card-body p-4">
            <form action="{{ route('faculty.leave.update', $leaveApplication->id) }}" method="POST" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" name="contact_during_leave" class="form-control @error('contact_during_leave') is-invalid @enderror"
                    value="{{ old('contact_during_leave', $leaveApplication->contact_during_leave) }}" placeholder="Enter contact number">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="date" name="start_date" class="form-control @error('start_date') is-invalid @enderror"
                    value="{{ old('start_date', $leaveApplication->start_date->format('Y-m-d')) }}" required>
                  @error('start_date')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="date" name="end_date" class="form-control @error('end_date') is-invalid @enderror"
                    value="{{ old('end_date', $leaveApplication->end_date->format('Y-m-d')) }}" required>
                  @error('end_date')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="mb-3">
                ...
                <textarea name="reason" rows="4" class="form-control @error('reason') is-invalid @enderror"
                  placeholder="Please provide detailed reason for leave..." required>{{ old('reason', $leaveApplication->reason) }}</textarea>
                @error('reason')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              ...
              <div class="mb-3">
                ...
                <div class="mb-2">
                  ...
                  <a href="{{ $leaveApplication->attachment }}" target="_blank" class="text-primary">
                    <i class="fas fa-file-alt me-1"></i>View Current
                  </a>
                </div>
                @endif
              ...
              <div class="alert alert-warning">
                ...
                <strong>Note:</strong> You can only edit pending leave applications. Once approved or rejected,
