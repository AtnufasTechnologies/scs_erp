...
<head>
  ...
  <title>Salesian College Autonomous - Student Forgot Password</title>
      ...
      <div class="col align-items-center flex-col ">
        <div class="form-wrapper align-items-center">
          <div class="form sign-in">
            <form action="{{route('student.password.reset.send')}}" method="post">
              @csrf
              <img src="{{asset('admin/images/logo.png')}}" alt="logo">
              <h3>Salesian College Autonomous</h3>
              <h5>Sonada and Siliguri</h5><br>

              <h3>Student - Forgot Password</h3>

              <div class="input-group">
                <i class='fa fa-id-card'></i>
                <input type="text" placeholder="Roll Number" name="roll_no" value="{{old('roll_no')}}">
                @error('roll_no')
