      ...
      <div class="ps-2">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('principal.api-scores.reports') }}">API Score Reports</a></li>
            ...
            <div class="table-responsive">
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  @empty
                  <tr>
                    <td colspan="10" class="text-center">No API scores found for this faculty</td>
                  </tr>
                  @endforelse
                </tbody>
              </table>
