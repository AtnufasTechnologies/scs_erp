  ...
  <main class="page-content">
    ...
    <div class="container-fluid py-4">
          ...
          <div class="card gradient-coe shadow-lg border-0">
            <div class="card-body p-4">
              <div class="row align-items-center">
                <div class="col-md-8">
                  <h3 class="text-white fw-bold mb-2"><i class="fas fa-user-plus me-2"></i>Assign Invigilation Duty</h3>
                  <p class="text-white-50 mb-0">Assign a faculty member to an invigilation duty</p>
                </div>
      ...
      <div class="card shadow-sm border-0">
        <div class="card-body p-4">
          <form action="{{ route('admin.invigilation-duties.store') }}" method="POST">
            @csrf
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <select name="role" class="form-select @error('role') is-invalid @enderror" required>
                  ...
                  <option value="chief_invigilator" {{ old('role') === 'chief_invigilator' ? 'selected' : '' }}>Chief Invigilator</option>
                  <option value="invigilator" {{ old('role') === 'invigilator' ? 'selected' : '' }}>Invigilator</option>
                  <option value="reliever" {{ old('role') === 'reliever' ? 'selected' : '' }}>Reliever</option>
                </select>
                @error('role')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
