...
<div class="wrapper">
  ...
  <div class="p-4 mb-4 bg-gradient-primary text-white rounded-3 shadow">
    <div class="container-fluid py-3">
      <h1 class="display-6 fw-bold">Manual Seating Allocation</h1>
      <p class="fs-6 mb-0 text-dark">Manually assign seat to a student</p>
    </div>
  </div>
      ...
      <div class="col-md-8">
        <div class="card shadow-sm">
          <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><i class="fa fa-plus"></i> Create Seating Allocation</h5>
          </div>
          <div class="card-body">
            @if($errors->any())
            ...
            <form action="{{ route('admin.seating-allocation.store') }}" method="POST">
              @csrf
              ...
              <div class="alert alert-info">
                ...
                <strong>Note:</strong> Make sure the student is registered for the selected exam before allocating a seat.
              </div>
