          ...
          <div class="card gradient-coe shadow-lg border-0">
            <div class="card-body p-4">
              <h3 class="text-white fw-bold mb-0">
                <i class="fas fa-edit me-2"></i>Edit Regulation
              </h3>
              <small class="text-white-50">Last updated: {{ $regulation->updated_at->format('d M Y, h:i A') }}</small>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-10 col-md-12 mx-auto">
          <div class="card shadow-sm border-0">
            ...
            <div class="card-body p-4">
              <form action="{{ route('coe.regulations.update', $regulation->id) }}" method="POST" id="regulationForm">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="regulationName" name="regulation_name"
                      ...
                      value="{{ old('regulation_name', $regulation->regulation_name) }}" required>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="regulationType" name="regulation_type" required>
                      <option value="" disabled>Select regulation type...</option>
                      <option value="Annual" {{ old('regulation_type', $regulation->regulation_type) == 'Annual' ? 'selected' : '' }}>Annual</option>
                      <option value="Semester" {{ old('regulation_type', $regulation->regulation_type) == 'Semester' ? 'selected' : '' }}>Semester</option>
                      <option value="Choice Based" {{ old('regulation_type', $regulation->regulation_type) == 'Choice Based' ? 'selected' : '' }}>Choice Based</option>
                    </select>
                  </div>
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <select class="form-select" id="programId" name="program_id" required>
                      ...
                      <option value="{{ $program->id }}" {{ old('program_id', $regulation->program_id) == $program->id ? 'selected' : '' }}>
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="startYear" name="start_year"
                      ...
                      value="{{ old('start_year', $regulation->start_year) }}" required>
                  </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="endYear" name="end_year"
                      ...
                      value="{{ old('end_year', $regulation->end_year) }}" required>
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                  ...
                  <button type="submit" class="btn btn-primary" id="submitBtn">
                    <i class="fa fa-save me-1"></i>Update Regulation
                  </button>
                </div>
              </form>
            </div>
