...
<head>
  ...
  <title>Salesian College Autonomous| Sonada and Siliguri - Admission Portal Closed</title>
        ...
        <div class="header-content">
          ...
          <div class=" card shadow p-4">
            <div class="card-body text-center">
              <h2 class="mb-4" style="color:aliceblue">Admissions Closed</h2><br>
              <p class="mb-4 " style="color:aliceblue">We regret to inform you that the admission process for the {{ $batch ?? 'current' }} batch is now closed. We appreciate your interest in Salesian College Autonomous and encourage you to check back for future admission cycles.</p>
              <br>
