...
@if($isPrincipalMonitoring ?? false)
<div class="wrapper">
  ...
  <main class="page-content">
    ...
    <div class="container-fluid p-4">
      <h4 class="mb-3">{{ ($isPrincipalMonitoring ?? false) ? 'Student Pathway Mapper Monitor' : 'ITCELL Student Pathway Mapper' }}</h4>

      @if($isPrincipalMonitoring ?? false)
      <div class="alert alert-info">Monitoring mode: updates are disabled for Principal view.</div>
      @endif
      ...
      <div class="card shadow-sm mb-4">
        <div class="card-body">
          <form action="{{ ($isPrincipalMonitoring ?? false) ? route('principal.pathway.mapper') : route('itcell.pathway.mapper') }}" method="GET" class="row g-3 align-items-end">
            <div class="col-md-2">
