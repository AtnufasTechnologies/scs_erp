...
<h3><span class="text-uppercase">Religion Master</span></h3>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{url('erp/admin/master/religion')}}" method="post">
        @csrf
  ...
  <table class="table mt-3 mb-3" id="exportTable">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="{{url('erp/admin/master/del-religion/'.$item->id)}}" id="citadel"><button class="btn btn-outline-danger"><i class="fas fa-trash-alt"></i></button></a></td>
