...
//ajax department programs combination fetching
$("#admissiondepartment").change(function () {
    var departmentId = $("#admissiondepartment").val();
    ...
    if (departmentId == "") {
        ...
        $.ajax({
            type: "get",
            url: "getcombinations-bydepartment",
            data: {
